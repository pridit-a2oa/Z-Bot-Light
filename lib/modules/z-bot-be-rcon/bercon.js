...
class ZBotBERcon
{
   ...
   */
  bindChannels() {
    this.channels.command = this._bot.channels.cache.get(this.cfg.channels.commands);
    this.channels.side = this._bot.channels.cache.get(this.cfg.channels.side);
    this.channels.group = this._bot.channels.cache.get(this.cfg.channels.group);
    this.channels.direct = this._bot.channels.cache.get(this.cfg.channels.direct);
    this.channels.admin = this._bot.channels.cache.get(this.cfg.channels.admin);
    this.channels.connect = this._bot.channels.cache.get(this.cfg.channels.joins);
    this.channels.vehicle = this._bot.channels.cache.get(this.cfg.channels.vehicle);
    this.channels.default = this._bot.channels.cache.get(this.cfg.channels.default);
    this.channels.global = this._bot.channels.cache.get(this.cfg.channels.global);
   // this.channels.log = this._bot.channels.cache.get(this.cfg.channels.log);
