...
class ZBotBERcon {
  ...
  init() {
    ...
    if (this._continue) {
      ...
      Helper.sendTextMessage(
        this._reloadChannel,
        this.cfg.name + ' : ' + 'No default channel set or found. Mandatory!'
      );
    }
  }
   ...
   */
  bindChannels() {
    this.channels.command = this._guild.channels.cache.get(
      this.cfg.channels.commands
    );
    this.channels.side = this._guild.channels.cache.get(this.cfg.channels.side);
    this.channels.group = this._guild.channels.cache.get(
      this.cfg.channels.group
    );
    this.channels.direct = this._guild.channels.cache.get(
      this.cfg.channels.direct
    );
    this.channels.admin = this._guild.channels.cache.get(
      this.cfg.channels.admin
    );
    this.channels.connect = this._guild.channels.cache.get(
      this.cfg.channels.joins
    );
    this.channels.vehicle = this._guild.channels.cache.get(
      this.cfg.channels.vehicle
    );
    this.channels.default = this._guild.channels.cache.get(
      this.cfg.channels.default
    );
    this.channels.global = this._guild.channels.cache.get(
      this.cfg.channels.global
    );
    // this.channels.log = this._guild.channels.cache.get(this.cfg.channels.log);
    ...
    if (this.channels.default) {
      if (this.channels.default.type === 0) {
        this._continue = true;
  ...
  disconnectedListener(extra) {
    ...
    if (extra && extra === 'stop') {
      ...
      Helper.sendTextMessage(
        ...
        'RCON server disconnected on purpose. ZBot reload'
      );
    } else {
    ...
    if (err) {
      ...
      if (success === true) {
        ...
        Helper.sendTextMessage(
          this.channels.default,
          this._cfg.name +
            ': RCON login failed! Check your authentications and zbot reload.'
        );
      }
    }
  }
  ...
  hasCorrectRole(message, command) {
    ...
    if (role) {
      let answer = message.member.roles.cache.some((r) => r.name === role);
      if (!answer) {
        Helper.sendTextMessage(
          message.channel,
          'You need the following role to use this command: ' + role
        );
      }
      return answer;
    }
  ...
  checkAdminCommand(message) {
    ...
    if (message.channel.id === this.channels.global.id) {
      ...
      switch (true) {
        case message.content.includes('!rcon teststeam '):
          ...
          this.cmdSteamTestPrintData(
            message.content.toString().replace('!rcon teststeam ', '')
          );
          break;
        ...
        case message.content.includes('!rcon say all '):
          ...
          this.cmdSayGlobalMessage(
            message.content.toString().replace('!rcon say all ', '')
          );
          break;
        case message.content.includes('!rcon say '):
          ...
          this.cmdSayPlayerMessage(
            message.content.toString().replace('!rcon say ', '')
          );
          break;
        ...
        case message.content.includes('!rcon removeBan '):
          ...
          this.cmdRemoveBan(
            message.content.toString().replace('!rcon removeBan ', '')
          );
          break;
        ...
        case message.content.includes('!rcon addBan '):
          ...
          this.cmdAddBan(
            message.content.toString().replace('!rcon addBan ', '')
          );
          break;
        case message.content.includes('!rcon MaxPing '):
          ...
          this.cmdSetMaxPing(
            message.content.toString().replace('!rcon MaxPing ', '')
          );
          break;
        case message.content.includes('!rcon kick '):
          ...
          this.cmdKickPlayer(
            message.content.toString().replace('!rcon kick ', '')
          );
          break;
        ...
        case message.content.includes('!rcon #'):
          ...
          this.cmdServerCommand(
            message.content.toString().replace('!rcon ', '')
          );
          break;
