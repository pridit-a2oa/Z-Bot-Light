  ...
  chatMessagesAction(message) {
    ...
    switch (true) {
      ...
      case (message.startsWith('RCon admin') ):
        ...
        break;
      case (message.startsWith('Verified GUID') || Array.isArray(message.match(/\b(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\b/)) ):
        disableShow = true;
        break;
